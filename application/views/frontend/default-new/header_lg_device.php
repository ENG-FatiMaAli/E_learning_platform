  ...
  <div class="container">
    ...
    <div class="navbar-collapse" id="navbarSupportedContent">
      ...
      <div class="right-menubar ms-auto">
        ...
        <div class="wisth_tgl_div me-2">
          <a href="javascript:void(0);" onclick="actionTo('<?php echo site_url('home/dark_and_light_mode') ?>')" class="theme-toggle-btn" title="<?php echo get_phrase('Toggle theme'); ?>">
