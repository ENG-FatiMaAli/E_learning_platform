...
<section class="h-1-banner bannar-area pb-5">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-12 col-sm-12 col-12 order-2 order-lg-1 d-flex align-items-center">
                <div class="h-1-banner-text EbannerLeft position-relative w-100">
                    <?php
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-12 order-1 order-lg-2 pt-0 pt-lg-5">
