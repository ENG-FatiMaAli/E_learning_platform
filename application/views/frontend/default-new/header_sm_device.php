    ...
    <div class="offcanvas-body p-0">
      <div class="flex-shrink-0 mt-3">
        <ul class="list-unstyled ps-0">
          ...
          <!-- Theme switcher for mobile devices -->
          <li>
            <a href="javascript:void(0);" onclick="actionTo('<?php echo site_url('home/dark_and_light_mode') ?>')" class="btn btn-toggle-list d-inline-flex align-items-center rounded border-0 text-dark text-16px fw-500 w-100 theme-toggle-mobile-btn">
              <i class="fa-solid fa-moon dark-icon me-2"></i>
              <i class="fa-solid fa-sun light-icon me-2"></i>
              <span><?php echo get_phrase('Toggle Theme'); ?></span>
            </a>
          </li>
